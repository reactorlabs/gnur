...
#define EXTERNALSXP_PTRS(x)		((SEXP*)(((uintptr_t)EXTERNALSXP_HEADER(x)) + EXTERNALSXP_PTRS_OFFSET(x)))
...
externRir R_bcstack_t *R_BCNodeStackBase, *R_BCNodeStackTop, *R_BCNodeStackEnd;
#ifdef BC_INT_STACK
